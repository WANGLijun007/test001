...
//        find link category object-wlj
//        final Category category = (Category)_categoryDAO.findByPrimaryKey(product.get
    ...
    /*
     * (non-Javadoc)
     * @see com.yaps.petstore.common.delegate.CatalogServiceRemote#findProducts(java.lang.String)
     * New add
     */
	@Override
	public Collection findProducts(String categoryId) throws FinderException, RemoteException {
        ...
        final Collection productsTMP = _productDAO.findAll();
        
        for (Iterator iterator = productsTMP.iterator(); iterator.hasNext();) {
	...
	public Collection findItems(String productId) throws FinderException, RemoteException {
        ...
        final Collection itemsTMP = _itemDAO.findAll();

        for (Iterator iterator = itemsTMP.iterator(); iterator.hasNext();) {
